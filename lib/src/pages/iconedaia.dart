...
class CloseableAiCard extends StatefulWidget {
  ...
  const CloseableAiCard({Key? key, this.scaleFactor = 1.0}) : super(key: key);
            ...
            child: Stack(
              children: [
                Positioned(
                  ...
                  child: _buildBlurBall(Colors.deepPurpleAccent.shade400),
                ),
                Positioned(
                  bottom: -3 * 16.0,
                  left: _initialCardWidth / 2 - (3 * 16.0),
                  child: _buildBlurBall(Color(0xFF00FFAA)),
                ),
                Positioned(
                  top: _initialCardHeight / 2 - (3 * 16.0),
                  left: -3 * 16.0,
                  child: _buildBlurBall(Color(0xFFFF1E8E)),
                ),
                Positioned(
                  top: _initialCardHeight / 2 - (3 * 16.0),
                  right: -3 * 16.0,
                  child: _buildBlurBall(Color(0xFF00FFFF)),
                ),
              ],
            ),
          ),
